export const profile = {
  ...
  social: {
    github: 'https://github.com/shawtygirlzzzz',
    linkedin: 'https://www.linkedin.com/in/fareen-nathrah-8a9751285/',
  },
  resumeUrl: '/resume.pdf',
  location: 'Melaka, Malaysia',
  spokenLanguages: ['English', 'Malay', 'German'],
  availability: 'Open to internships and AI/ML opportunities',
};
